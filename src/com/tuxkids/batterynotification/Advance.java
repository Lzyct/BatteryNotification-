...
//	}
			...
			public void onReceive(Context context, Intent intent) {
				...
				if (intent.ACTION_BATTERY_CHANGED.equals(action)) {
					...
					int scale = intent.getIntExtra(BatteryManager.EXTRA_SCALE,
							100);
					mBatteryLevel.setSummary(String
							.valueOf(level * 100 / scale) + "%");
	...
	public void updateTime() {
		...
		mBatteryTime.setSummary(String.valueOf(DateUtils
				.formatElapsedTime(uptime / 1000)));
	...
	public void setValue() {
		...
		cb1.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
			@Override
